...
async function getLocationFromIp(ip) {
    ...
    try {
        ...
        try {
            const response = await axios_1.default.get(`https://get.geojs.io/v1/ip/geo/${cleanIp}.json`, {
                timeout: 5000
            });
        ...
        try {
            const response = await axios_1.default.get(`http://ip-api.com/json/${cleanIp}?fields=status,message,country,countryCode,city`, {
                timeout: 3000
            });
        ...
        try {
            ...
            const response = await axios_1.default.get(`https://ipinfo.io/${cleanIp}/json?token=0277d573b05252`, {
                timeout: 3000
            });
        ...
        if (cleanIp === '127.0.0.1' ||
            ...
            try {
                const response = await axios_1.default.get('https://get.geojs.io/v1/ip/geo.json', {
                    timeout: 3000
                });
                if (response.data && response.data.country_code) {
                    const flag = countryCodeToFlag(response.data.country_code);
